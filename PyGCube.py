...
class Graphics:
    ...
    def _SetupArrows(self):
        ...
        BPMove = self._MakeMove((self._Front[8].screen_position[0]+.3, self._Front[8].screen_position[1]-.3, 0), color.red, (180, 0, 0), "Turn")
        BPMove.tooltip = Tooltip("Shuffle", scale = Vec2(0.7, 0.7))
